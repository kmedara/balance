...
import{a as oe,b as ae,c as le,d as ce,e as w,f as se,h as de,i as pe,j as ue,k as me}from"./chunk-SYG22T6A.mjs";import{e as Z,g as ee,h as te,v as ne,w as ie,z as re}from"./chunk-4KYDLXRS.mjs";import{$a as z,Fb as M,H as I,Ia as C,J as q,Ja as B,K as O,La as A,Ma as p,O as b,T as Q,U as N,Ua as U,Va as L,Wa as V,Xa as P,Y as S,Ya as c,Za as s,_a as d,aa as T,db as E,ea as k,eb as R,fb as h,gb as $,ib as H,jb as u,kb as G,lb as D,mb as m,nb as f,ob as g,qb as J,rb as v,sa as o,sb as _,tb as j,ub as K,vb as W,wb as X,xb as Y,zb as x}from"./chunk-WP2KOEG3.mjs";import"./chunk-T55IDOPT.mjs";function fe(e,i){let l=!i?.manualCleanup?i?.injector?.get(S)??b(S):null,n=be(i?.equal),a;i?.requireSync?a=T({kind:0},{equal:n}):a=T({kind:1,value:i?.initialValue},{equal:n});let r,F=e.subscribe({next:y=>a.set({kind:1,value:y}),error:y=>{a.set({kind:2,error:y}),r?.()},complete:()=>{r?.()}});if(i?.requireSync&&a().kind===0)throw new I(601,!1);return r=l?.onDestroy(F.unsubscribe.bind(F)),M(()=>{let y=a();switch(y.kind){case 1:return y.value;case 2:throw y.error;case 0:throw new I(601,!1)}},{equal:i?.equal})}function be(e=Object.is){return(i,t)=>i.kind===1&&t.kind===1&&e(i.value,t.value)}var ge=`
    .p-card {
