...
import{b as ne,c as re,d as _,e as x}from"./chunk-B4SXRSLL.mjs";import{S as X,ca as Y,da as Z,ea as ee,fa as D,ma as te}from"./chunk-V3BHSU5V.mjs";import{j as J,l as K,n as W}from"./chunk-X4V7OQD6.mjs";import{Ab as u,Bb as j,Cb as E,D as M,G as F,Ga as A,H as N,Ha as U,Ib as z,J as q,Ka as $,L as f,La as P,Ma as l,T as B,Tb as G,V as T,aa as h,ca as Q,cb as s,da as I,db as y,eb as b,f as R,fa as k,jb as w,kb as S,lb as v,pb as g,qb as V,ra as c,rb as C,sb as H,ub as d,vb as p,zb as L}from"./chunk-OBUNMCM3.mjs";function $e(t,r){let e=r?.injector??f(B),o=new R(1),n=Q(()=>{let a;try{a=t()}catch(i){I(()=>o.error(i));return}I(()=>o.next(a))},{injector:e,manualCleanup:!0});return e.get(T).onDestroy(()=>{n.destroy(),o.complete()}),o.asObservable()}function Pe(t,r){let o=!r?.manualCleanup?r?.injector?.get(T)??f(T):null,n=se(r?.equal),a;r?.requireSync?a=h({kind:0},{equal:n}):a=h({kind:1,value:r?.initialValue},{equal:n});let i,O=t.subscribe({next:m=>a.set({kind:1,value:m}),error:m=>{a.set({kind:2,error:m}),i?.()},complete:()=>{i?.()}});if(r?.requireSync&&a().kind===0)throw new M(601,!1);return i=o?.onDestroy(O.unsubscribe.bind(O)),G(()=>{let m=a();switch(m.kind){case 1:return m.value;case 2:throw m.error;case 0:throw new M(601,!1)}},{equal:r?.equal})}function se(t=Object.is){return(r,e)=>r.kind===1&&e.kind===1&&t(r.value,e.value)}var ie=`
    .p-card {
...
//# sourceMappingURL=chunk-TDXZW2ZK.mjs.map
